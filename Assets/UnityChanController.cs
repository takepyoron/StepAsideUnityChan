...
public class UnityChanController : MonoBehaviour {
    ...
    void Update() {
        ...
        //jumpステートの場合jumpにfalseをセットする
        if (this.myAnimator.GetCurrentAnimatorStateInfo(0).IsName("Jump"))
        {
            this.myAnimator.SetBool("Jump", false);
        }

        //ジャンプしていないときスペースが押されたときジャンプする
